...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "colinfkennedy-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/ckennedy"
  #   chef.validation_client_name = "ckennedy-validator"
  #   chef.validation_key_path = ".chef/ckennedy-validator.pem"
  # end
end
